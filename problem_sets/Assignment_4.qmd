...
The most informative might be the plot for 1.7 or 1.8, since it computes CPI and HDI, and clearly shows the trends in different regions of the world. It seems like there is a correlation of lower the CPI, lower the HDI, across all region. SSA seems to have both lowest CPI and HDI, and EU W. Europe has the highest.
